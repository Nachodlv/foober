            ...
            <table class="table-bordered" align="center" style="text-align:center;">
                ...
                <tr>
                    <td>
                        ...
                        <img id="imgClient" src="" style="width: 8rem; height: 8rem">
                    </td>
                    <td></td>
                    <td>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDRtC9nTA8nx3D7jpH07HcU5SjpLhQgA6E&libraries=places&callback=getOrder"
        async defer></script>
</body>
</html>
